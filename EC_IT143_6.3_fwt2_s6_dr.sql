...
UPDATE dbo.t_hello_world SET my_message = 'Hello World4'
 ...
 -- See if trigga worked
 Select t.*
   FROM dbo.t_hello_world AS t;



-- Q4: How to keep track of why someone updated a record?
-- A5: This works for the initial INSERT...

ALTER TABLE dbo.t_hello_world
ADD last_modified_why VARCHAR(50) DEFAULT 'updating record';